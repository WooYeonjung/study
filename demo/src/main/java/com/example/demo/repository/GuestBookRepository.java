...
//      - deleteById(키) 삭제의 경우에도 select 후 없으면 오류없이 실행하지않음.
//		 ( Boot2 까지는 없으면 ~DataAccessException 발생 )
...
public interface GuestBookRepository //JpaRepository<T, ID> t: 사용할 entity, id: key의 타입
